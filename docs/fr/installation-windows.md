...
L'installeur embarque les modeles FastEmbed/ONNX verifies par manifeste. La
premiere synchronisation fonctionne donc hors ligne et ne telecharge aucun
modele. Le corpus et l'index restent locaux.
